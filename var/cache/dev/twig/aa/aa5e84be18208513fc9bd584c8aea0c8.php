...
class __TwigTemplate_274a9ff9797c9fa8a6e63349b2e3f6c0 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["pointderelai"]) {
            ...
            echo "</td>
                ...
                <td>
                    <a href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_pointderelais_front_show", ["idPointderelais" => twig_get_attribute($this->env, $this->source, $context["pointderelai"], "idPointderelais", [], "any", false, false, false, 25)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_pointderelais_front_edit", ["idPointderelais" => twig_get_attribute($this->env, $this->source, $context["pointderelai"], "idPointderelais", [], "any", false, false, false, 26)]), "html", null, true);
            echo "\">edit</a>
...
";
    ...
    {
        return array (  137 => 38,  132 => 35,  123 => 31,  113 => 26,  109 => 25,  103 => 22,  99 => 21,  95 => 20,  91 => 19,  88 => 18,  83 => 17,  68 => 4,  58 => 3,  35 => 1,);
    }
