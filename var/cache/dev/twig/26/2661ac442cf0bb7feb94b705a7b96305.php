...
class __TwigTemplate_ee7c6f7500a8da25f67f63375ec8b2aa extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    <h1>Add new Reclamation</h1>
    ";
        // line 5
...
{% block body %}
    <h1>Add new Reclamation</h1>
    {{ form_start(form) }}
        {{ form_widget(form) }}
        <button type=\"submit\" class=\"btn btn-primary\">Submit</button>
    {{ form_end(form) }}
{% endblock %}
", "reclamation/new.html.twig", "C:\\Users\\hp\\OneDrive\\Bureau\\final-master\\templates\\reclamation\\new.html.twig");
    }
}
