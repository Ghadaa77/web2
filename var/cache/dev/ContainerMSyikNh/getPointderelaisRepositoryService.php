 ...
 */
class getPointderelaisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PointderelaisRepository' shared autowired service.
     *
     * @return \App\Repository\PointderelaisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PointderelaisRepository.php';

        return $container->privates['App\\Repository\\PointderelaisRepository'] = new \App\Repository\PointderelaisRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
